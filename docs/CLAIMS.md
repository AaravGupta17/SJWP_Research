...
| Uses a physics-based synthesiser (Torricelli amplitude, wave speed, attenuation) | REWORD | Physics-*inspired*: E10 measured plastic-pipe attenuation at 0.6–2.5 dB/m, about 100× more than the synthesiser applies (≈0.004 dB/m at α = 0.001/m). Say the attenuation was not calibrated, and show the measured values. |
