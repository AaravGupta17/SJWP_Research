...
| Real buried networks | Hong Kong (Tijani, Tariq, Zayed et al., Mendeley Data doi:10.17632/hkn8mxcjyz.1, 2022, CC BY 4.0): noise loggers and hydrophones at real leak sites and no-leak sites, metal and plastic pipes | `datasets/public/hongkong/` |
